    ...
    // Research / Publications & Theory / Cultural Analytics
{
  ...
  description: 'Developed at UC San Diego\'s Qualcomm Institute, the GeoMedia Analytics Platform combines APIs from Google Earth, Google Maps, and Google Street View to investigate large public cultural datasets, including geo-tagged social photos across New York City. The interface synchronizes spatial and temporal views so users can scan a location, activate image pins, and watch photos appear where they were taken based on metadata. This made it possible to compare neighborhood-level cultural patterns and trace how activity shifts across Park Avenue and other urban corridors.',
  description2: 'The web-based prototype was primarily built in JavaScript with responsive modules designed for 4K displays and scalable from mobile devices to Qualcomm Institute\'s 100-million-pixel tiled wall. It supports filtering by date, time, and user, and incorporates image-recognition workflows to study patterns such as indoor vs. outdoor behavior, food, and movement through the city. Beyond cultural analytics, the platform was framed for practical applications including urban planning, power-infrastructure assessment, and environmental health analysis.',
  description3: 'A related 2014 UCSD collaboration applied the same immersive analytics workflow to pediatric asthma in San Diego County, combining school district records, public health indicators, and respiratory trends in an interactive 3D geospatial environment. Our work translated these layered datasets into map-based visual narratives that highlighted neighborhood risk signals and helped frame future directions for collaborative health and environmental analysis.',
  projectTag: ['research', 'data-viz', 'leadership'],
  images: ['/images/CulturalAnalytics_screenshot1.jpg','/images/CulturalAnalytics_screenshot2.jpg','/images/AsthmaAnalytics.jpg'],
