  ...
  // Creative / Tangible Artifacts / Horizons
{
  ...
  // Creative / Tangible Artifacts / Now & Then
  {
    ...
    note: 'n/a',
    isSeries: true,
    heroImage: '/images/whirlpool-ape-comp-2-large.jpeg',
    ...
    images: [
    '/images/whirlpool-ape-comp-2-large.jpeg',
  ...
  // Research / Display & Interaction Systems / Day in the Life
{
  ...
  description3: 'The work is building toward interactive visualizations. Every path is grounded in an actual lens recording rather than a simulated monologue — partial evidence of accessible internal representation, not a claim of machine consciousness.',
  heroImage: '/images/jspace.jpg',
  ...
  // Research / Pedagogy & Labs / UCSD\
{
  ...
  description: 'As Technical Director for UCSD\'s Software Studies initiative, I translated the lab\'s critical framework into deployable analytics systems for real-world stakeholders. The work emphasized how software mediates social and institutional decision-making, moving from theory into operational visual analytics environments.',
  description2: 'One major project was a Kaiser Permanente air-quality and pediatric respiratory analytics platform that integrated public health indicators, school district context, and environmental signals into a shared geospatial interface. Built on osgEarth-based tooling, the system supported interactive exploration of neighborhood-level risk patterns and collaborative interpretation across research and healthcare audiences.',
  description3: 'A second project, developed with Accenture and PwC at the Qualcomm Institute, pioneered an ultra-high-resolution analytics environment for global insurance leaders. Utilizing SAGE middleware, I delivered an executive-facing experience on the 32-panel tiled display wall. The platform synchronized 3D Google Earth risk overlays with real-time multi-dimensional dashboards and gesture-controlled agent filters. The project culminated in immersive StarCAVE sessions for Allstate’s C-suite, where abstract property risk models were translated into 360-degree navigable environments, significantly reducing the gap between complex data analysis and strategic decision-making.',
  projectTag: ['research', 'data-viz', 'leadership'],
  images: ['/images/AsthmaAnalytics.jpg','/images/AccenturePwCVroom.jpg'],
